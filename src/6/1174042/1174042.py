...
orang = [11,22,16,9,10,15,22,55,62,45,21,22,24,20,21,19,34,42,42,4,2,102,95,85,55,110,120,70,65,55,111,115,80,75,65,54,44,43,42,48,50,29,14,68]
...
plt.scatter(x,y, label='pendapatan tinggi simpanan rendah',color='g')
...
plt.xlabel('x')
plt.ylabel('y')
plt.title('Kegiatan Sehari-hari Najib')
plt.legend()
plt.show()
...
plt.ylabel('Tahun')
plt.xlabel('Jumlah Pemakai Sistem Operasi Linux pada Tahun ke tahun')
plt.show()
...
bar = __import__('1174042_bar')
scat = __import__('1174042_scatter')
pie = __import__('1174042_pie')
plot = __import__('1174042_plot')
